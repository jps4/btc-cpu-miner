...
// default settings
#define DEFAULT_SSID		"Fantasia"
#define DEFAULT_WIFIPW		"--------"
#define DEFAULT_POOLURL		"public-pool.io"
#define DEFAULT_POOLPASS	"x"
#define DEFAULT_WALLETID	"bc1qawcmkz0f406sfwple0u7xarmvh3ms5uusu8l66"
...
struct TSettings
{
	std::string WifiSSID{ DEFAULT_SSID };
	std::string WifiPW{ DEFAULT_WIFIPW };
	std::string PoolAddress{ DEFAULT_POOLURL };
